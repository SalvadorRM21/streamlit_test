...
with col1:
    ...
    fig_7, ax_7 = plt.subplots(figsize=(12, 4))  # Adjust height
...
with col2:
    ...
    fig_8, ax_8 = plt.subplots(figsize=(12, 4))  # Adjust height
...
with col1:
    ...
    fig_9, ax_9 = plt.subplots(figsize=(12, 4))  # Adjust height
...
with col2:
    ...
    fig_10, ax_10 = plt.subplots(figsize=(12, 4))  # Adjust height
